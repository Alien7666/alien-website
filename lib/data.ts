...
export const experiencesData = [
  {
    ...
    location: "全端開發人員",
    description:
      "開發前後端設計師網站，除了UI/UX以外，負責前端介面以及功能的開發、後端的API設計、資料庫架構、伺服器架構、雲端服務架構等等，總耗時約五個月。",
...
export const projectsData = [
  ...
  },
  {
    title: "設計師網站",
    description:
      "為我讀設計系的朋友開發了前端網站，後端使用上面的Spring boot，前端使用React，UI由設計師提供，我負責實現如聯絡表單.篩選作品.後台的作品更新等等的相關功能，並且使用上個專案製作的Restful API來從Spring boot後端取得資料以及身分驗證。",
    tags: ["React", "Next.js", "type script", "Tailwind"],
    imageUrl: yinzReact,
...
export const skillsData = {
  ...
  資料庫: ["MongoDB", "MySQL"],
  伺服器:["NGINX","Apache"],
  雲服務:["AWS","Google Cloud Platform","Azure"],
